public class EjemploStringMetodos {
    public static void main(String[] args) {
        ...
        System.out.println("nombre.equals(\"Andres\") = " + nombre.equals("Andres")); // retorna True si es igual
        ...
        System.out.println("nombre.compareTo(\"Andres\") = " + nombre.compareTo("Andres")); // retorna 0 si es igual
        ...
        System.out.println("trabalenguas.indexOf('z') = " + trabalenguas.indexOf('z')); // Si >= 0 SI ENCUENTRA
